        ...
        <div>
          <div className='t'>
            ...
            <table className='t-table'>
              <caption>NADOLAZEĆI TRENINZI NA KOJE SI PRIJAVLJEN</caption>
              <tr>
          ...
          <div className='t'>
          <table className='t-table'>
              <caption>NADOLAZEĆI TRENINZI NA KOJE SE MOŽEŠ PRIJAVITI</caption>
              <tr>
                <th>Datum i vrijeme</th>
                <th>Lokacija</th>
                <th>Trajanje</th>
    ...
    <>
      ...
      <div className='podaciContainer' id='color-bg-primary'>
        ...
        <div>
          <div className='t'>
          <table className='t-table'>
              <caption>NADOLAZEĆI TRENINZI</caption>
              <tr>
                <th>Datum i vrijeme</th>
                <th>Lokacija</th>
                <th>Trajanje</th>
              ...
              {sviTreninzi.map((val,key) =>{
                return(
                  <tr key={key}>
                    ...
                    <td>{val.duration} min</td>
                    <td>{val.coachName}</td>
                    <td><button className='btn' onClick={() => obrisiTrening(val.id)}>Obriši</button></td>
                  </tr>
                )
              })}
              </table>
